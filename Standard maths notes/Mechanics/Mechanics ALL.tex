...
\begin{document}
	...
	\begin{tabular}{|m{3.5cm} | m{13.5cm}|}
		\hline
		\textbf{Model} & \textbf{Assumptions} \\
		\hline
		Particle & Mass of the object is concentrated at a single point, rotational forces and air resistance can be ignored, volume is negligible \\
		\hline
