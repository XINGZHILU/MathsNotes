...
\input{chapters/P1/1.tex}

\chapter{Quadratics}
\input{chapters/P1/2.tex}

\chapter{Equations and inequalities}
\input{chapters/P1/3.tex}

\chapter{Graphs and transformations}
\input{chapters/P1/4.tex}

\chapter{Straight line graphs}
\input{chapters/P1/5.tex}

\chapter{Circles}
\input{chapters/P1/6.tex}

\chapter{Algebraic methods}
\input{chapters/P1/7.tex}

\chapter{The binomial expansion}
\input{chapters/P1/8.tex}

\chapter{Trigonometric ratios}
\input{chapters/P1/9.tex}

\chapter{Trigonometric identities and equations}
\input{chapters/P1/10.tex}

\chapter{Vectors}
\input{chapters/P1/11.tex}

\chapter{Differentiation}
\input{chapters/P1/12.tex}

\chapter{Integration}
\input{chapters/P1/13.tex}

\chapter{Exponentials and logarithms}
\input{chapters/P1/14.tex}

\part{Pure 2 Contents}
\chapter{Algebraic methods}
\input{chapters/P2/1.tex}

\chapter{Functions and graphs}
\input{chapters/P2/2.tex}

\chapter{Sequences and series}
\input{chapters/P2/3.tex}

\chapter{Binomial expansion}
\input{chapters/P2/4.tex}

\chapter{Radians}
\input{chapters/P2/5.tex}

\chapter{Trigonometric functions}
\input{chapters/P2/6.tex}

\chapter{Trigonometry and modelling}
\input{chapters/P2/7.tex}

\chapter{Parametric equations}
\input{chapters/P2/8.tex}

\chapter{Differentiation}
\input{chapters/P2/9.tex}

\chapter{Numerical methods}
\input{chapters/P2/10.tex}

\chapter{Integration}
\input{chapters/P2/11.tex}

\chapter{Vectors}
\input{chapters/P2/12.tex}

\part{Applied 1 Statistics}
\chapter{Data collection}
\input{chapters/A1/1.tex}

\chapter{Measurements of location and spread}
\input{chapters/A1/2.tex}

\chapter{Representations of data}
\input{chapters/A1/3.tex}

\chapter{Correlation}
\input{chapters/A1/4.tex}

\chapter{Probability}
\input{chapters/A1/5.tex}

\chapter{Statistical distributions}
\input{chapters/A1/6.tex}

\chapter{Hypothesis testing}
\input{chapters/A1/7.tex}

\part{Applied 1 Mechanics}
\setcounter{chapter}{7}
\chapter{Modelling in mechanics}
\input{chapters/A1/8.tex}

\chapter{Constant acceleration}
\input{chapters/A1/9.tex}

\chapter{Forces and motion}
\input{chapters/A1/10.tex}

\chapter{Variable acceleration}
\input{chapters/A1/11.tex}
